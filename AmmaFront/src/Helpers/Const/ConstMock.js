    ...
    switch (service) {
        ...
        case 'buscarTicketsAtivos':
            return [
                ...
                { id: 3, tipo: 3 ,usuario: { id: '1', idImagem: '1', nome: 'PessoaService', cargo: 'Programador' }, titulo: 'Microsof Teams', descricao: 'Lorem ing industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500ss', data: '05/08/2020', votos: 6 },
                ...
                { id: 5, tipo: 4 ,usuario: { id: '1', idImagem: '1', nome: 'PessoaService', cargo: 'Programador' }, titulo: 'Hub Salvador', descricao: '', data: '12/10/2020', votos: 1 },
                { id: 6, tipo: 3 ,usuario: { id: '1', idImagem: '1', nome: 'PessoaService', cargo: 'Programador' }, titulo: 'Lixeira', descricao: 'O cuidado em identificar pontos críticos na adoção de políticas descentralizadoras estimula a padronização dos níveis de motivação departamental.', data: '04/10/2021', votos: 35 },
            ];
